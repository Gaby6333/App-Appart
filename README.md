...
- **Dépenses** : 3 sous-onglets. "Résumé" — qui a payé combien ce mois-ci et le règlement automatique qui en découle (qui doit combien à qui), avec le graphique des 6 derniers mois et la répartition par catégorie repliés derrière "Voir plus de détails". "Historique" — la liste des dépenses ponctuelles du mois, formulaire d'ajout replié derrière un bouton "+". "Récurrentes" — les dépenses qui reviennent chaque mois (loyer, internet...) où tu coches juste "payé" sans retaper, avec un jour du mois optionnel (pour qu'elle apparaisse au calendrier). Un export CSV du mois affiché est disponible dans l'en-tête.
